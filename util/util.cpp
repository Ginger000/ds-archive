...
pid_t exec_cmd(const char *cmd,
  ...
  if (pid == 0) {
    ...
    char libpath[] =
        "LD_LIBRARY_PATH=/software/intel-composer-2011u5-x86_64/lib/intel64/:$LD_LIBRARY_PATH"; // path for libiomp5.so
    char licenses[] =
        "INTEL_LICENSE_FILE=28518@intel.webstore.illinois.edu:/software/intel-composer-2011u5-x86_64/composerxe-2011.5.220/licenses:/opt/intel/licenses:/home/massung1/intel/licenses"; // also for parallel labs
  ...
  for (int arg_i = 1; arg_i < argc; arg_i++) {
    ...
    if (strncmp(currarg, "--", 2) == 0) //long option
    {
      ...
      switch (valuechar) {
        ...
        case 'y'   :value = true;
          break;
        default:cerr << "Unknown option value: " << currarg << endl;
          return currarg;
      }
